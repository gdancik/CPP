...
tabResults <- tabPanel("Results",
                       ...
                       fluidRow(column(style='border-right: 1px solid',width = 12,
                                       tabsetPanel(id = "MainPage",
                                                   ...
                                                   addTabPanel("Cancer Types", "diseaseResults", "cancerGraph", "statCancerTable"),
                                                   addTabPanel("Selected Genes", "multiGeneResults", "multiGeneGraph"),
                                                   addTabPanel("Cancer Terms", "cancerTermResults", "cancerTermGraph", 'statCancerTermTable'),
                                                   addTabPanel('Drugs', 'chemResults', "chemGraph", "statChemTable"),
                                                   addTabPanel("Mutations", "mutationResults", "mutGraph", "statMutTable"),
                                                   addTabPanel("Additional Genes", "geneResults", "geneGraph", "statGeneTable"),
